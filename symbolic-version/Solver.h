...
class Solver {
 ...
 private:
  ...
  //inline bool constraintIsConflictingOrPropagating( const PBConstraint &c ) const {
    //return constraintIsConflictingOrPropagating(WConstraint(c));
  //}

  //inline bool constraintIsConflictingOrPropagating( const WConstraint &c ) const {
